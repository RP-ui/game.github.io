...
for(var i=0;i<400;i++){
    ...
    document.getElementById(c).innerHTML=document.getElementById(c).innerHTML+("<div id='_"+times+"' style='background:lightyellow;width:"+Math.floor(screen.width/360)+"px"+";height:"+Math.floor(screen.height)+"px"+";float:left;z-index:99;'></div>");
